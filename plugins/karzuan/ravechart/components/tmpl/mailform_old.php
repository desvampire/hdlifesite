...
$(document).ready(function() { 
	 ...
	 $('#Send').click(function() {  
			...
			$.post("/modules/mod_mapgen/tmpl/post.php", str, function(response) {
	 ...
	 {
	 	document.getElementById('captcha').src="/modules/mod_mapgen/tmpl/get_captcha.php?rnd=" + Math.random();
	 }
...
if ($_POST['action'] =='form')
	{
		...
		<div id="cap_wrap"><label class="lsmall">Символы с картинки</label> <input id="code" name="code" type="text" /><img id="refresh" src="/modules/mod_mapgen/tmpl/refresh.jpg" alt="" width="25" />
		<div id="cap_img"><img id="captcha" src="/modules/mod_mapgen/tmpl/get_captcha.php" alt="" /></div>
		</div>
